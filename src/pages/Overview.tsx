...
const Overview = () => {
  ...
  return (
    <div className="bg-gray-100 h-full w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 tablet:grid-cols-12 lg:grid-cols-3 xl:grid-cols-12 2xl:grid-cols-3 gap-6">
        {/* My Cards Section */}
        <section
          aria-labelledby="my-cards-section"
          className="col-span-2 md:col-span-2 tablet:col-span-7 lg:col-span-2 xl:col-span-7 2xl:col-span-2"
        >
        ...
        <section
          ...
          className="col-span-2 tablet:col-span-5 lg:col-span-1 xl:col-span-5 2xl:col-span-1 w-full"
        >
        ...
        <section
          ...
          className="col-span-2 lg:col-span-1 xl:col-span-5 md:col-span-2 tablet:col-span-5 2xl:col-span-1"
        >
          <SectionHeading title="Expense Statistics" />
          <div className="bg-white shadow-sm rounded-lg flex xl:w-pie-chart-container-width h-pie-chart-container-height">
      ...
      <div className="flex flex-col tablet:flex-row justify-between gap-x-6">
        {/* Quick Transfer Section */}
        <section
          aria-labelledby="quick-transfer-section"
          className="tablet:min-w-quick-transfer-card-container-width tablet:w-quick-transfer-card-container-width mt-6"
        >
