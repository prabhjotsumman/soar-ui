...
interface ChipBlackIconProps extends React.SVGProps<SVGSVGElement> {
    color?: string;
}

const ChipBlackIcon: React.FC<ChipBlackIconProps> = ({ color = 'url(#pattern0_14_1343)', ...props }) => (
    <svg
        width="35"
        height="35"
        viewBox="0 0 35 35"
        ...
        {...props}
    >
        <rect width="34.7713" height="34.7713" fill={color} />
        <defs>
